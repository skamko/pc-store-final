...
class ProductForm(FlaskForm):
    ...
    image_url = StringField('სურათის ლინკი (URL)', validators=[DataRequired()])
...
def add_product():
    ...
    form = ProductForm()
    if form.validate_on_submit():
        new_product = Product(name=form.name.data, description=form.description.data, price=form.price.data, image_url=form.image_url.data)
